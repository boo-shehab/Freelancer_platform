...
import ApplyToProjectFormPopup from "../../components/ApplyToProjectFormPopup/ApplyToProjectFormPopup";
...
const HomeScreen = () => {
  ...
  return (
    <div style={styles.homeScreen}>
      <ApplyToProjectFormPopup isOpen={isPopupOpen} onClose={() => setIsPopupOpen(false)}/>
